...
type Conn struct {
	...
	// TimeStampFloat is used when reading from json files
	TimeStampFloat float64 `bson:"-" json:"ts"`
...
func (in *Conn) ConvertFromJSON() {
	in.TimeStamp = int64(in.TimeStampFloat)
}
